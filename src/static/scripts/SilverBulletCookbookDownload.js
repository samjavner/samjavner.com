			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Silver Bullet Cookbook')
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Recipe management and meal planning made easy!')
							]))
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$href('/static/sbc/downloads/SilverBulletCookbook-1.1.1.exe')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Download Silver Bullet Cookbook')
					]))
			]));
};
